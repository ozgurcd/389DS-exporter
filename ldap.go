...
func getStats() DSData {
	...
	var anonymousbinds string
	var unauthbinds string
	var simpleauthbinds string
	var strongauthbinds string
	var bindsecurityerrors string
	var inops string
	var readops string
	var compareops string
	var addentryops string
	var removeentryops string
	var modifyentryops string
	var modifyrdnops string
	var searchops string
	var onelevelsearchops string
	var wholesubtreesearchops string
	var referrals string
	var securityerrors string
	var errors string
	var connections string
	var connectionseq string
	var connectionsinmaxthreads string
	var connectionsmaxthreadscount string
	var bytesrecv string
	var bytessent string
	var entriesreturned string
	var referralsreturned string
